...
<?php $__env->startSection('content'); ?>
  ...
  <section class="content">
      <div class="row">
          <div class="col-md-12">
          <form role="form" enctype="multipart/form-data" method="post" action="<?php echo e(url('flight-create-submit')); ?>">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="flight_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Flight Name" value="<?php echo e(old('flight_name')); ?>" required="">
