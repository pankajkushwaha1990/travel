  ...
  <div class="row">
    <div class="col-12">
       <div class="card">
         <div class="card-body">
          <div class="row">
                    <h6><img  style="height: 80px;width: 350px;" src="<?php echo e(url('').'/offer_docs/logo.png'); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="row">
            ...
            <div class="col-md-3"><sup>(office use only)</sup><sup>____<?php echo e($agent->assign_id); ?>____</sup></div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-1"><?php echo e($agent->title); ?></div>
            <div class="col-md-1" style="background-color: #d7d7d7;">Gender:</div>
            <div class="col-md-2"><?php echo e($agent->gender); ?></div>
         ...
         <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-4"><?php echo e($agent->emergency_contact_name); ?></div>
            <div class="col-md-2" style="background-color: #d7d7d7;">Relationship to you:</div>
            <div class="col-md-4"><?php echo e($agent->emergency_relation_to_you); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-2" style="background-color: #d7d7d7;">Contact Number:</div>
            <div class="col-md-10"><?php echo e($agent->emergency_contact_number); ?></div>
          </div>
           <div class="row" style="background-color: #002060;color: white;">
         ...
         <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-2"><?php echo e($agent->other_than_english); ?></div>
            <div class="col-md-2" style="background-color: #d7d7d7;">Yes, specify:</div>
            <div class="col-md-3"><?php echo e($agent->other_than_english_specify); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-5" style="background-color: #d7d7d7;">Are you of Aboriginal or Torres Strait Islander origin?</div>
            <div class="col-md-7"><?php echo e($agent->islander_origin); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-1"><input type="checkbox"  <?php echo e($agent->significant_disability=='No' ? "checked" : ""); ?> name="">No</div>
            <div class="col-md-2"><input type="checkbox" <?php echo e($agent->significant_disability=='Yes' ? "checked" : ""); ?> name="">Yes, please indicate:</div>
          </div>
          <?php 
          ...
          <div class="row">
            ...
            <div class="col-md-2"><input <?php echo e(in_array('Hearing',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Hearing / Deaf</div>
            <div class="col-md-2"><input <?php echo e(in_array('Physical',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Physical</div>
            <div class="col-md-2"><input <?php echo e(in_array('Intellectual',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Intellectual</div>
            <div class="col-md-2"><input <?php echo e(in_array('Learning',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Learning</div>
          </div>
          <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-2"><input  <?php echo e(in_array('Vision',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Vision</div>
            <div class="col-md-2"><input <?php echo e(in_array('Mental',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Mental illness</div>
            <div class="col-md-2"><input <?php echo e(in_array('Medical',$disArray) ? "checked" : ""); ?> type="checkbox" name="">Medical condition</div>
            <div class="col-md-2"><input <?php echo e($finalDids!='' ? "checked" : ""); ?> type="checkbox" name="">Other, specify:</div>
            <div class="col-md-3"><?php echo e($finalDids); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-2" style="background-color: #d7d7d7;">Yes, specify:</div>
            <div class="col-md-2"><?php echo e($agent->english_test_specify); ?></div>
            <div class="col-md-1" style="background-color: #d7d7d7;">Score:</div>
            <div class="col-md-2"><?php echo e($agent->english_score); ?></div>
            <div class="col-md-2" style="background-color: #d7d7d7;">Date undertaken:</div>
            <div class="col-md-2"><?php echo e($agent->english_date); ?></div>
          </div>
           <div class="row" style="background-color: #002060;color: white;">
         ...
         <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-4"><input <?php echo e($agent->health_cover=='No' ? "checked" : ""); ?> type="checkbox" name="">No.  If, "no" please provide your membership no.:</div>
            <div class="col-md-3">_______<?php echo e($agent->mambership_no); ?>_________</div>
            <div class="col-md-3">Policy expiry date:</div>
            <div class="col-md-2"><?php echo e($agent->policy_expire); ?></div>
          </div>
          <div class="row">
            <div class="col-md-5"><input <?php echo e($agent->health_cover=='Yes' ? "checked" : ""); ?> type="checkbox" name="">Yes.  If "yes", what type of OSHC policy will you require?</div>
            <div class="col-md-3">_______<?php echo e($agent->policy_no); ?>_________</div>
          </div>
          <div class="row">
         ...
         <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-3"><input <?php echo e(in_array('12 eq',$highArray) ? "checked" : ""); ?> type="checkbox" name="">Year 12 eq</div>
            <div class="col-md-3"><input <?php echo e(in_array('11 eq',$highArray) ? "checked" : ""); ?> type="checkbox" name="">Year 11 eq</div>
            <div class="col-md-3"><input <?php echo e(in_array('10 eq',$highArray) ? "checked" : ""); ?> type="checkbox" name="">Year 10 or below</div>
            <div class="col-md-3"><input <?php echo e(in_array('N/A',$highArray) ? "checked" : ""); ?> type="checkbox" name="">N/A</div>
          </div>
           <div class="row" style="border-top: 1px solid #101010;border-bottom: 1px solid #101010;">
            ...
            <div class="col-md-4"><?php echo e($agent->year_completed); ?></div>
            <div class="col-md-2" style="background-color: #d7d7d7;">Country:</div>
            <div class="col-md-4"><?php echo e($agent->completion_country); ?></div>
          </div>
  <br>
    ...
    <div class="col-12">
       <div class="card">
         ...
         <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-1"><input <?php echo e($agent->is_completed_qualification=='No' ? "checked" : ""); ?> type="checkbox" name="">No</div>
            <div class="col-md-10"><input <?php echo e($agent->is_completed_qualification=='Yes' ? "checked" : ""); ?> type="checkbox" name="">Yes (If yes, tick all applicable boxes)</div>
          </div>
          <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-4"><input <?php echo e(in_array('Bachelor degree or higher degree',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Bachelor degree or higher degree</div>
            <div class="col-md-3"><input <?php echo e(in_array('Certificate IV',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Certificate IV</div>
            <div class="col-md-3"><input <?php echo e(in_array('Certificate I',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Certificate I</div>
          </div>
          <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-4"><input <?php echo e(in_array('Advanced diploma or associate degree',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Advanced diploma or associate degree</div>
            <div class="col-md-3"><input <?php echo e(in_array('Certificate III/Trade Certificate',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Certificate III/Trade Certificate</div>
            <div class="col-md-3"><input <?php echo e(in_array('Other education',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Other education</div>
          </div> <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-4"><input <?php echo e(in_array('Diploma or associate diploma',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Diploma or associate diploma</div>
            <div class="col-md-3"><input <?php echo e(in_array('Certificate II',$compArray) ? "checked" : ""); ?> type="checkbox" name="">Certificate II</div>
          </div>
          <?php 
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-2"><input <?php echo e(in_array('Australian',$cntqaArray) ? "checked" : ""); ?> type="checkbox" name="">Australian</div>
            <div class="col-md-2"><input <?php echo e(in_array('Australian equivalent',$cntqaArray) ? "checked" : ""); ?> type="checkbox" name="">Australian equivalent</div>
            <div class="col-md-2"><input <?php echo e(in_array('International',$cntqaArray) ? "checked" : ""); ?> type="checkbox" name="">International</div>
          </div>
           <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-4"><input <?php echo e(in_array('To get a job',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">To get a job</div>
            <div class="col-md-4"><input <?php echo e(in_array('To start my own business',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">To start my own business</div>
            <div class="col-md-4"><input <?php echo e(in_array('To develop my existing business',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">To develop my existing business</div>
          </div>
          <div class="row">
            <div class="col-md-4"><input <?php echo e(in_array('To try a different career',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">To try a different career</div>
            <div class="col-md-4"><input <?php echo e(in_array('I want extra skills for my job',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">I want extra skills for my job</div>
            <div class="col-md-4"><input <?php echo e(in_array('It was a requirement of my job',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">It was a requirement of my job</div>
          </div> 
          <div class="row">
            <div class="col-md-12"><input <?php echo e(in_array('Other reasons',$reasaArray) ? "checked" : ""); ?> type="checkbox" name="">Other reasons:</div>
          </div>
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-4"><input <?php echo e(in_array('Full time employee',$statusArray) ? "checked" : ""); ?> type="checkbox" name="">Full time employee</div>
            <div class="col-md-4"><input <?php echo e(in_array('Part time employee',$statusArray) ? "checked" : ""); ?> type="checkbox" name="">Part time employee</div>
            <div class="col-md-4"><input <?php echo e(in_array('Self employed',$statusArray) ? "checked" : ""); ?> type="checkbox" name="">Self employed</div>
          </div>
          <div class="row">
            <div class="col-md-4"><input <?php echo e(in_array('Employer',$statusArray) ? "checked" : ""); ?> type="checkbox" name="">Employer</div>
            <div class="col-md-4"><input <?php echo e(in_array('Unemployed',$statusArray) ? "checked" : ""); ?> type="checkbox" name="">Unemployed</div>
            <div class="col-md-4"><input <?php echo e(in_array('Not employed/not seeking employment',$statusArray) ? "checked" : ""); ?> type="checkbox" name="">Not employed/not seeking employment</div>
          </div> 
         ...
         <div class="row" style="border-top: 1px solid #101010;">
          ...
          <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            if(in_array( $cours->course_code,$courseArray)){?>
                 <div class="row" style="border-top: 1px solid #101010;">
              <div class="col-md-4"><input <?php echo e(in_array( $cours->course_code,$courseArray) ? "checked" : ""); ?> type="checkbox" name=""><?php echo e($cours->course_code); ?></div>
              <div class="col-md-4"><?php echo e($cours->course_name); ?></div>
              <div class="col-md-4">
                 <?php 
...
<br>
    ...
    <div class="col-12">
       <div class="card">
         <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-2"><input <?php echo e(in_array('No',$creditArray) ? "checked" : ""); ?> type="checkbox" name="">No</div>
            <div class="col-md-2"><input <?php echo e(in_array('Yes',$creditArray) ? "checked" : ""); ?> type="checkbox" name="">Yes</div>
          </div>
           <?php 
          ...
          ?>
           <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-2"></div>
            <div class="col-md-2"><input <?php echo e(in_array('No',$prevArray) ? "checked" : ""); ?> type="checkbox" name="">No</div>
            <div class="col-md-2"><input <?php echo e(in_array('Yes',$prevArray) ? "checked" : ""); ?> type="checkbox" name="">Yes</div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
          ...
          <div class="row">
            ...
            <div class="col-md-1"></div>
            <div class="col-md-2"><input <?php echo e(in_array('No',$airArray) ? "checked" : ""); ?> type="checkbox" name="">No</div>
            <div class="col-md-2"><input <?php echo e(in_array('Yes',$airArray) ? "checked" : ""); ?> type="checkbox" name="">Yes*</div>
          </div>
           <div class="row" style="border-top: 1px solid #101010;">
          ...
          ?>
            <div class="col-md-1"></div>
            <div class="col-md-2"><input <?php echo e(in_array('No',$assiArray) ? "checked" : ""); ?> type="checkbox" name="">No</div>
            <div class="col-md-2"><input <?php echo e(in_array('Yes',$assiArray) ? "checked" : ""); ?> type="checkbox" name="">Yes</div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
        ...
        www.usi.gov.au/faws/i-have-forgotten-my-usi/.</div>
         ...
         <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-10"><?php echo e($agent->usi_code); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
      ...
      the privacy policy information at www.usi.gov.au/documents/privacy-notice-when-rto-applies-their-behalf.</div>
          ...
          <div class="row">
            <div class="col-md-12">I <b><?php echo e($agent->surname." ".$agent->given_name); ?></b> authorise Ashton College to apply pursuant to sub-section 9(2) of the
       ...
       <div class="card">
         <div class="card-body">
          ...
          <div class="row">
           ...
           <div class="row">
            <div class="col-md-6"><input <?php echo e(!empty($agent->passport_file) ? "checked" : ""); ?> type="checkbox" name="">Certified copy of passport</div>
            <div class="col-md-6"><input <?php echo e(!empty($agent->qualification_file) ? "checked" : ""); ?> type="checkbox" name="">Certified copies of your academic qualifications</div>
          </div>
           <div class="row">
            <div class="col-md-6"><input <?php echo e(!empty($agent->language_file) ? "checked" : ""); ?> type="checkbox" name="">Evidence of your English Language ability</div>
            <div class="col-md-6"><input <?php echo e(!empty($agent->oshc_file) ? "checked" : ""); ?> type="checkbox" name="">Evidence of OSHC (if already purchased)</div>
          </div>
...
documentation when requested could result in cancelation of your enrolment.</div>
          ...
          <div class="row">
           ...
           <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-10"><?php echo e($agent->surname." ".$agent->given_name); ?></div>
          </div>
           <div class="row" style="border-top: 1px solid #101010;">
            <div class="col-md-3" style="background-color: #d7d7d7;">Student signature:</div>
            <div class="col-md-4"><img style="width: 72%;height: 48%;" src="<?php echo e(url('').'/student_docs/'.$agent->student_signature_file); ?>"></div>
            <div class="col-md-2" style="background-color: #d7d7d7;">Date:</div>
            <div class="col-md-3"><?php echo e($agent->submit_date); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;">
...
file.</i></div>
          ...
          <div class="row" style="border-top: 1px solid #101010;">
            ...
            <div class="col-md-4"><?php echo e(@$employee->name); ?></div>
            <div class="col-md-2" style="background-color: #d7d7d7;">Agency name:</div>
            <div class="col-md-3"><?php echo e(@$employee->company); ?></div>
          </div>
          <div class="row" style="border-top: 1px solid #101010;border-bottom: 1px solid #101010;">
            <div class="col-md-2" style="background-color: #d7d7d7;">Agent email address:</div>
            <div class="col-md-10"> <?php echo e(@$employee->email); ?> </div>
          </div>
 <div class="row">
...
<div class="row">
 ...
 <div class="row" style="border-top: 1px solid #101010;border-bottom: 1px solid #101010;">
            ...
            <div class="col-md-9"><img style="width: 20%;height: 57%;" src="<?php echo e(url('').'/agent_docs/'.@$employee->signature_file); ?>"></div>
          </div>
...
<?php if(!empty($agent->passport_file)): ?>

  <?php if(strpos($agent->passport_file,'.pdf')===false): ?>
        ...
        <br>
          ...
          <div class="row">
            <div class="col-md-12">
              <img src="<?php echo e(url('').'/student_docs/'.$agent->passport_file); ?>">
            </div>
      </div>
  <?php else: ?> 
  ...
  <embed
    src="<?php echo e(url('').'/student_docs/'.$agent->passport_file); ?>"
    width="1040px"
    height="1000px"
    style="border: none;"
    class="hidePdf"
...
<?php if(!empty($agent->qualification_file)): ?>


<?php if(strpos($agent->qualification_file,'.pdf')===false): ?>
         <div class="breakPage"></div>
           <div class="row">
...
<br>
          <div class="row">
            <div class="col-md-12">
              <img src="<?php echo e(url('').'/student_docs/'.$agent->qualification_file); ?>">
            </div>
      </div>
  <?php else: ?> 
   <div class="row hidePdf">
 ...
 <embed
    src="<?php echo e(url('').'/student_docs/'.$agent->qualification_file); ?>"
    width="1040px"
    height="1000px"
    style="border: none;"
    class="hidePdf"
...
<?php if(!empty($agent->language_file)): ?>



<?php if(strpos($agent->language_file,'.pdf')===false): ?>
<div class="breakPage"></div>
           <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              <img src="<?php echo e(url('').'/student_docs/'.$agent->language_file); ?>">
            </div>
      </div>
  <?php else: ?> 
  <div class="row hidePdf">
 ...
 <embed
    src="<?php echo e(url('').'/student_docs/'.$agent->language_file); ?>"
    width="1040px"
    height="1000px"
    style="border: none;"
    class="hidePdf"
...
<br>
<?php endif; ?>
<?php if(!empty($agent->oshc_file)): ?>



<?php if(strpos($agent->oshc_file,'.pdf')===false): ?>
<div class="breakPage"></div>
           <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              <img src="<?php echo e(url('').'/student_docs/'.$agent->oshc_file); ?>">
            </div>
      </div>
  <?php else: ?> 
  <div class="row hidePdf">
 ...
 <embed
    src="<?php echo e(url('').'/student_docs/'.$agent->oshc_file); ?>"
    width="1040px"
    height="1000px"
    style="border: none;"
    class="hidePdf"
...
<br>
<?php endif; ?>
<?php if(!empty($agent->student_other_file)): ?>



          <?php if(strpos($agent->student_other_file,'.pdf')===false): ?>
          <div class="breakPage"></div>
           <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              <img src="<?php echo e(url('').'/student_docs/'.$agent->student_other_file); ?>">
            </div>
      </div>
  <?php else: ?> 
   <div class="row hidePdf">
 ...
 <embed
    src="<?php echo e(url('').'/student_docs/'.$agent->student_other_file); ?>"
    width="1040px"
    height="1000px"
    class="hidePdf"
    style="border: none;"
