                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="proffered_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Proffered Name" value="<?php echo e(old('proffered_name')); ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="country" class="form-control" id="exampleInputEmail1" placeholder="Enter Agent Country" value="<?php echo e(old('country')); ?>" required="">
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="australian_visa_details" class="form-control australian_visa_details" id="exampleInputEmail1" placeholder="Enter Street Address" value=""><?php echo e(old('australian_visa_details')); ?></textarea>
