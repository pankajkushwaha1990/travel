...
<?php $__env->startSection('content'); ?>
  ...
  <section class="content">
      <div class="row">
          <div class="col-md-12">
          <form role="form" method="post" action="<?php echo e(url('student-approval-change-status-submit')); ?>">
...
<div class="row">
              ...
              <input type="hidden" name="student_id" value="<?php echo e($agent->student_id); ?>">
              <input type="hidden" name="student_email" value="<?php echo e($agent->student_email); ?>">
              <div class="row">
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" required="" name="approval_status">
                      ...
                      <option <?php echo e(($agent->approval_status)==0 ? "selected" : ""); ?> value="0">Pending</option>

                      <option <?php echo e(($agent->approval_status)=='1' ? "selected" : ""); ?> value="1">Approved</option>

                      <option <?php echo e(($agent->approval_status)=='2' ? "selected" : ""); ?> value="2">Decliend</option>
                      <option <?php echo e(($agent->approval_status)=='3' ? "selected" : ""); ?> value="3">In-Process</option>
                      <option <?php echo e(($agent->approval_status)=='4' ? "selected" : ""); ?> value="4">Completed</option>
                      <option <?php echo e(($agent->approval_status)=='5' ? "selected" : ""); ?> value="5">Cancled</option>
                    </select>
                  </div>
                </div>
