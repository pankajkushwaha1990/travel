...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <tr>
            ...
            <td> 
              <button type="button" class="btn btn-primary btn-sm pay_modal" user_name="<?php echo e(ucfirst($package->user_details[0]->name)); ?>" user_id="<?php echo e($package->user_id); ?>" package_name="<?php echo e(ucfirst($package->package_details[0]->package_name)); ?>" package_id="<?php echo e($package->package_id); ?>" final_cost="<?php echo e($package->final_package_cost); ?>" pending_cost="<?php echo e($package->pending_amount); ?>">
                  Pay
                </button>
  ...
  <div class="modal fade" id="pay_modal" style="display: none;" aria-hidden="true">
        ...
        <form role="form" enctype="multipart/form-data" method="post" action="<?php echo e(url('user-package-payment-create-submit')); ?>">
