...
<?php $__env->stopSection(); ?>
  ...
  <section class="content">
      <div class="row">
          <div class="col-md-12">
          <form role="form" enctype="multipart/form-data" method="post" action="<?php echo e(url('email-compose-submit')); ?>">
                       ...
                       <div class="form-group">
                        ...
                        <select name="to_array[]" class="form-control Reciever" required="" multiple="multiple">
                          ...
                          <?php $__currentLoopData = $agent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($agents->email); ?>"><?php echo e($agents->name." (".$agents->email.")"); ?></option>
                          ...
                          <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($agents->email); ?>"><?php echo e($agents->surname." (".$agents->email.")"); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </optgroup>
