  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-5"><h3 class="card-title">Settings List</h3></div>
                <div class="col-md-6">
                    <h5 class="card-title">
        ...
        <tr>
            <td><?php echo e($course->application_fee); ?></td>
            <td><?php echo e($course->oshc_amount); ?></td>
            <td>
                <form action="<?php echo e(url('student', $course->id)); ?>" method="post">
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                  <input type="hidden" name="_method" value="DELETE">
                  <a href="<?php echo e(url('setting-edit/'.base64_encode($course->id))); ?>">
