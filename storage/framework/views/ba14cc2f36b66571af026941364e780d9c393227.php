...
<?php $__env->startSection('content'); ?>
  ...
  <section class="content">
      <div class="row">
          <div class="col-md-12">
           <form role="form" enctype="multipart/form-data" method="post" action="<?php echo e(url('student-edit-submit')); ?>">
           <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
           <input type="hidden" name="student_id" value="<?php echo e($agent->id); ?>">
          <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <select name="title" class="form-control" required="">
                            ...
                            <option value="Mr." <?php echo e(($agent->title)=='Mr.' ? "selected" : ""); ?>>Mr.</option>
                            <option value="Mrs." <?php echo e(($agent->title)=='Mrs.' ? "selected" : ""); ?>>Mrs.</option>
                          </select>
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <select name="gender" class="form-control">
                            <option <?php echo e(($agent->gender)=='Male' ? "selected" : ""); ?> value="Male">Male</option>
                            <option <?php echo e(($agent->gender)=='Female' ? "selected" : ""); ?> value="Female">Female</option>
                            <option <?php echo e(($agent->gender)=='Intermediate' ? "selected" : ""); ?> value="Intermediate">Intermediate</option>
                          </select>
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input name="date_of_birth" type="text" class="form-control datepicker" id="exampleInputEmail1" placeholder="Enter Date Of Birth" value="<?php echo e($agent->date_of_birth); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input name="email" type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Email Address" value="<?php echo e($agent->email); ?>" required="">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="surname" class="form-control" id="exampleInputEmail1" placeholder="Enter Surname" value="<?php echo e($agent->surname); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="given_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Given Name" value="<?php echo e($agent->given_name); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="proffered_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Proffered Name" value="<?php echo e($agent->proffered_name); ?>" >
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="passport_number" class="form-control" id="exampleInputEmail1" placeholder="Enter Passport Number" value="<?php echo e($agent->passport_number); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="phone_number" class="form-control" id="exampleInputEmail1" placeholder="Enter Phone Number" value="<?php echo e($agent->phone_number); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="post_code" class="form-control" id="exampleInputEmail1" placeholder="Enter Postal Code" value="<?php echo e($agent->post_code); ?>" required="">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="town" class="form-control" id="exampleInputEmail1" placeholder="Enter Town" value="<?php echo e($agent->town); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="state" class="form-control" id="exampleInputEmail1" placeholder="Enter State" value="<?php echo e($agent->state); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="country" class="form-control" id="exampleInputEmail1" placeholder="Enter Agent Country" value="<?php echo e($agent->country); ?>" required="">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="town_city_birth" class="form-control" id="exampleInputEmail1" placeholder="Enter Town/City" value="<?php echo e($agent->town_city_birth); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <input type="text" name="birth_country" class="form-control" id="exampleInputEmail1" placeholder="Enter Birth Country" value="<?php echo e($agent->birth_country); ?>" required="">
                      ...
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <select name="valid_australian_visa" class="form-control valid_australian_visa">
                            <option <?php echo e(($agent->valid_australian_visa)=='No' ? "selected" : ""); ?> value="No">No</option>
                            <option <?php echo e(($agent->valid_australian_visa)=='Yes' ? "selected" : ""); ?> value="Yes">Yes</option>
                          </select>
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="street_address" class="form-control" id="exampleInputEmail1" placeholder="Enter Street Address" value="" required=""><?php echo e($agent->street_address); ?></textarea>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="australian_visa_details" class="form-control australian_visa_details" id="exampleInputEmail1" placeholder="Enter Street Address" value=""><?php echo e($agent->australian_visa_details); ?></textarea>
                    ...
                    <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="emergency_contact_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact Name" value="<?php echo e($agent->emergency_contact_name); ?>" required="">
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <input name="emergency_relation_to_you" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Relationship to you" value="<?php echo e($agent->emergency_relation_to_you); ?>" required="">
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <input name="emergency_contact_number" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Contact Number" value="<?php echo e($agent->emergency_contact_number); ?>" required="">
                    ...
                    <div class="row">
                          <div class="col-md-5">
                            <div class="form-group">
                              <label for="exampleInputEmail1">Do you speak a language other than English at home? *</label><br>
                                ...
                                <input type="radio"  name="other_than_english" <?php echo e(($agent->other_than_english)=='Yes' ? "checked" : ""); ?> id="yes" value="Yes">
                                <label for="yes">Yes</label>
                             
                                <input type="radio" id="no" <?php echo e(($agent->other_than_english)=='No' ? "checked" : ""); ?> name="other_than_english" value="No">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" name="other_than_english_specify" class="form-control" id="exampleInputEmail1" placeholder="Specify" value="<?php echo e($agent->other_than_english_specify); ?>">
                            ...
                            <div class="form-group">
                              <label for="exampleInputEmail1">Are you of Aboriginal or Torres Strait Islander origin? *</label>
                               <select name="islander_origin" class="form-control">
                                <option <?php echo e(($agent->islander_origin)=='Neither' ? "selected" : ""); ?> >Neither</option>
                                <option <?php echo e(($agent->islander_origin)=='Yes, Aboriginal' ? "selected" : ""); ?> >Yes, Aboriginal</option>
                                <option <?php echo e(($agent->islander_origin)=='No, T.S. Islander' ? "selected" : ""); ?>>No, T.S. Islander</option>
                              </select>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="radio" <?php echo e(($agent->significant_disability)=='No' ? "checked" : ""); ?>  name="significant_disability" id="no1" value="No">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                             <input type="radio" value="Yes" <?php echo e(($agent->significant_disability)=='Yes' ? "checked" : ""); ?>  id="yes1" name="significant_disability">
                        ...
                        <?php 
                              $disArray = json_decode($agent->disability_value,true);
                              if(!empty($disArray)){
                         ...
                         <div class="row">
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <br>
                                ...
                                <input type="radio" <?php echo e(($agent->english_test)=='Yes' ? "checked" : ""); ?>  name="english_test" id="yes99" value="Yes">
                                <label for="yes99">Yes</label>
                             
                                <input type="radio" name="english_test" id="no99" <?php echo e(($agent->english_test)=='No' ? "checked" : ""); ?> value="No">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <label for="exampleInputEmail1">Yes, specify: *</label>
                               <select name="english_test_specify" class="form-control">
                                <option <?php echo e(($agent->english_test_specify)=='IELTS' ? "selected" : ""); ?> >IELTS</option>
                                <option <?php echo e(($agent->english_test_specify)=='PTE Academic' ? "selected" : ""); ?>>PTE Academic</option>
                                <option <?php echo e(($agent->english_test_specify)=='TOEFL (Paper Based)' ? "selected" : ""); ?> >TOEFL (Paper Based)</option>
                                <option <?php echo e(($agent->english_test_specify)=='TOEFL (Internet Based)' ? "selected" : ""); ?> >TOEFL (Internet Based)</option>
                                <option <?php echo e(($agent->english_test_specify)=='Cambridge English (FCE)' ? "selected" : ""); ?> >Cambridge English (FCE)</option>
                                <option <?php echo e(($agent->english_test_specify)=='Cambridge English (CAE)' ? "selected" : ""); ?> >Cambridge English (CAE)</option>
                                <option <?php echo e(($agent->english_test_specify)=='Cambridge English (CPE)' ? "selected" : ""); ?> >Cambridge English (CPE)</option>
                                <option <?php echo e(($agent->english_test_specify)=='Other' ? "selected" : ""); ?>>Other</option>
                              </select>
                           ...
                           <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" name="english_score" class="form-control" id="exampleInputEmail1" placeholder="Enter Score" value="<?php echo e(($agent->english_score)); ?>">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="english_date" class="form-control datepicker" id="exampleInputEmail1" placeholder="Enter Date" value="<?php echo e($agent->english_date); ?>">
                  ...
                  <div class="card-body">
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <br>
                                ...
                                <input type="radio" <?php echo e(($agent->health_cover)=='Yes' ? "checked" : ""); ?> name="health_cover" value="Yes" id="yes101">
                                <label for="yes101">Yes</label>
                             
                                <input type="radio" name="health_cover" value="No" id="no101" <?php echo e(($agent->health_cover)=='No' ? "checked" : ""); ?>>
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" name="mambership_no" class="form-control" id="exampleInputEmail1" placeholder="Membership No" value="<?php echo e($agent->mambership_no); ?>">
                           ...
                           <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text" name="policy_no" class="form-control" id="exampleInputEmail1" placeholder="Policy" value="<?php echo e($agent->policy_no); ?>">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" name="policy_expire" class="form-control" id="exampleInputEmail1" placeholder="Enter Date" value="<?php echo e($agent->policy_expire); ?>">
          ...
          <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <?php 
                              $disArray = json_decode($agent->highest_school);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                    ...
                    <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="year_completed" class="form-control" id="exampleInputEmail1" placeholder="Enter Year Completed" value="<?php echo e($agent->year_completed); ?>" required="">
                          ...
                          <div class="col-md-6">
                             <div class="form-group">
                              <label for="exampleInputEmail1">Country:</label>
                              <input name="completion_country" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Country" value="<?php echo e($agent->completion_country); ?>" required="">
                    ...
                    <div class="row">
                          <div class="col-md-2">
                             <div class="form-group">
                              <input name="is_completed_qualification" <?php echo e(($agent->is_completed_qualification)=='No' ? "checked" : ""); ?> type="checkbox" id="exampleInputEmail1" placeholder="Enter Relationship to you" value="No">No
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                              <input name="is_completed_qualification" <?php echo e(($agent->is_completed_qualification)=='Yes' ? "checked" : ""); ?> type="checkbox"  id="exampleInputEmail1" placeholder="Enter Relationship to you" value="Yes">Yes (If yes, tick all applicable boxes)
                              <?php if($errors->has('is_completed_qualification')): ?> <p style="color:red;"><?php echo e($errors->first('is_completed_qualification')); ?></p> <?php endif; ?>
                            </div>
                          </div>
                    </div>
                    <div class="row">
                          ...
                          <?php 
                              $disArray = json_decode($agent->completed_qualification,true);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                    ...
                    <?php 
                              $disArray = json_decode($agent->country_qualification,true);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                    ...
                    <?php 
                              $disArray = json_decode($agent->reason_qualification,true);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                                 $finalDids = end($disArray[7]);
                              }else{
                    ...
                    <div class="row">
                     ...
                     <?php 
                              $disArray = json_decode($agent->employment_status);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
          ...
          <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <?php 
                              $disArray = json_decode($agent->course_code);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              foreach ($weeks as $key => $week) {
                                if(!in_array($cours->course_code,$disArray)){
                                  $cources = null;
                                }else{
                                  $cources = $cours->course_code;
                                }
                                $match = $cources."||".$week."||".$course_amount[$key]."||".$material_amount[$key]."||". $selcted;
                                if(in_array($match, $final)){
                                  $checked = "checked";
                                }

                               ?>
                                <input <?php echo $checked;?>  type="radio" name="course_details[][<?php echo e($cours->course_code); ?>]" value="<?php echo e($week); ?>||<?php echo e($course_amount[$key]); ?>||<?php echo e($material_amount[$key]); ?>||<?php echo e($selcted++); ?>" id="<?php echo e($cours->course_code.$week); ?>">
                                <label for="<?php echo e($cours->course_code.$week); ?>"><?php echo $week;?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php if($errors->has('course_details')): ?> <p style="color:red;"><?php echo e($errors->first('course_details')); ?></p> <?php endif; ?>
                    ...
                    <div class="row">
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <input name="course_start_date" type="text" class="form-control datepicker" id="exampleInputEmail1" placeholder="Enter Start Date" value="<?php echo e($agent->course_start_date); ?>" required="">
                        ...
                        <div class="row">
                          ...
                          <?php 
                              $disArray = json_decode($agent->credit_transfer);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                        ...
                        <div class="row">
                          <div class="col-md-6">
                           ...
                           <?php 
                              $disArray = json_decode($agent->previous_studies);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
           ...
           <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                          ...
                          <?php 
                              $disArray = json_decode($agent->require_airport);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                        ...
                        ?>
                         ...
                         <div class="row">
                          ...
                          <?php 
                              $disArray = json_decode($agent->require_assistance);
                              if(!empty($disArray)){
                                 $disArray =  (array) @$disArray;
                              }else{
                                $disArray = array();
                  ...
                  <div class="card-body">
                    <div class="row">
                          <div class="col-md-6">
                           ...
                           <div class="col-md-3">
                             <div class="form-group">
                              <input name="usi_code" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Unique Student Identifier" value="<?php echo e($agent->usi_code); ?>" >
                    ...
                    <div class="row">
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file1">
                                  <input type="file" name="passport_file" class="custom-file-input2" id="exampleInputFile" <?php echo e(empty($agent->passport_file) ? "required" : ""); ?>>
                                  <input type="hidden" name="old_passport_file" value="<?php echo e($agent->passport_file); ?>">
                                  <?php if(strpos($agent->passport_file,'.')>0): ?>
                                   <a download href="<?php echo e(url('').'/student_docs/'.$agent->passport_file); ?>">Download</a>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                           ...
                           <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file1">
                                  <input type="file" name="qualification_file" class="custom-file-input2" id="exampleInputFile" <?php echo e(empty($agent->qualification_file) ? "required" : ""); ?>>
                                  <input type="hidden" name="old_qualification_file" value="<?php echo e($agent->qualification_file); ?>">
                                   <?php if(strpos($agent->qualification_file,'.')>0): ?>
                                   <a download href="<?php echo e(url('').'/student_docs/'.$agent->qualification_file); ?>">Download</a>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file1">
                                  <input type="file" name="language_file" class="custom-file-input2" id="exampleInputFile" <?php echo e(empty($agent->language_file) ? "" : ""); ?>>
                                  <input type="hidden" name="old_language_file" value="<?php echo e($agent->language_file); ?>">
                                   <?php if(strpos($agent->language_file,'.')>0): ?>
                                   <a download href="<?php echo e(url('').'/student_docs/'.$agent->language_file); ?>">Download</a>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file1">
                                  <input type="file" name="oshc_file" class="custom-file-input2" id="exampleInputFile" <?php echo e(empty($agent->oshc_file) ? "" : ""); ?>>
                                  <input type="hidden" name="old_oshc_file" value="<?php echo e($agent->oshc_file); ?>">
                                  <?php if(strpos($agent->oshc_file,'.')>0): ?>
                                   <a download href="<?php echo e(url('').'/student_docs/'.$agent->oshc_file); ?>">Download</a>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                           ...
                           <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file1">
                                  <input type="file" name="student_signature_file" class="custom-file-input2" id="exampleInputFile" <?php echo e(empty($agent->student_signature_file) ? "required" : ""); ?>>
                                  <input type="hidden" name="old_student_signature_file" value="<?php echo e($agent->student_signature_file); ?>">
                                  <?php if(strpos($agent->student_signature_file,'.')>0): ?>
                                   <a download href="<?php echo e(url('').'/student_docs/'.$agent->student_signature_file); ?>">Download</a>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <div class="input-group">
                                <div class="custom-file1">
                                  <input type="file" name="student_other_file" class="custom-file-input1" id="exampleInputFile" <?php echo e(empty($agent->student_other_file) ? "" : ""); ?>>
                                   <input type="hidden" name="old_student_other_file" value="<?php echo e($agent->student_other_file); ?>">
                                  <?php if(strpos($agent->student_other_file,'.')>0): ?>
                                   <a download href="<?php echo e(url('').'/student_docs/'.$agent->student_other_file); ?>">Download</a>
                                  <?php endif; ?>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-md-4">
                             <div class="form-group">
                              ...
                              <input type="text" name="submit_date" class="form-control datepicker" id="exampleInputEmail1" placeholder="Enter Date" value="<?php echo e($agent->submit_date); ?>" required="">
                                                          </div>
                          </div>                         
                        </div>
...
<script src="https://unpkg.com/bootstrap-datepicker@1.9.0/dist/js/bootstrap-datepicker.min.js"></script>
    ...
    format: 'dd/mm/yyyy'
               ...
               if(visaStatus=='' || visaStatus=='No'){
                 $('.australian_visa_details').prop('required',false);

               }else{
                 $('.australian_visa_details').prop('required',true);
               }
            })
                });
</script>
<script type="text/javascript">
  $(function(){
    ...
    $('[name="english_test"]').click(function(){
      var otherThan = $(this).val();
      if(otherThan=='Yes'){
         $('[name="english_test_specify"]').prop('readonly',false);
         $('[name="english_score"]').prop('readonly',false);
         $('[name="english_date"]').prop('readonly',false);
      }else{
       $('[name="english_test_specify"]').prop('readonly',true).val('');
