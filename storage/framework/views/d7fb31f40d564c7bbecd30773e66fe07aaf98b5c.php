     ...
     <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <form role="form" method="get" action="<?php echo e(url('report-single')); ?>">
          ...
          <div class="card">
                  <div class="card-body">
                    <div class="row">
                     ...
                     <div class="col-md-3">
                         <div class="form-group">
                          ...
                          <input name="start_date" type="text" class="form-control datepicker" placeholder="Select Start Date" value="<?php echo e($start_date); ?>" required="">
                         </div>
                      </div>
                      <div class="col-md-3">
                         <div class="form-group">
                          <label for="exampleInputEmail1">End Date</label>
                          <input name="end_date" type="text" class="form-control datepicker" placeholder="Select End Date" value="<?php echo e($end_date); ?>" required="">
                        </div>
                      </div>
                    ...
                    <label for="exampleInputEmail1">Reset</label>
                      <a href="<?php echo e(url('/report-single')); ?>"><button type="button" class="btn btn-block btn-primary">Reset</button></a>
                    </div>
                    </div>
    ...
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <tr>
            ...
            <td style="font-size: 14px;"><?php echo e($course->student_email); ?></td>
            <!-- <td style="font-size: 12px;"><?php echo e(ucfirst($course->type)); ?></td> -->
            <td style="font-size: 14px;"><?php echo e($course->agent_email); ?></td>

            <td style="font-size: 14px;"><?php echo e($totalFee[] = $course->debit_fee); ?></td>
            <td style="font-size: 14px;"><?php echo e(date('d/m/Y',strtotime($course->payment_date))); ?></td>
            <td style="font-size: 14px;"><?php echo e($course->agent_commision_percentage); ?> %</td>
            <td style="font-size: 14px;"><?php echo e($totalAgentComission[] =  ($course->debit_fee *  $course->agent_commision_percentage)/100); ?></td>
