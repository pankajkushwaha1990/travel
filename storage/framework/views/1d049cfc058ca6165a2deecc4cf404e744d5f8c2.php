...
.main-sidebar .brand-text, .sidebar .nav-link p, .sidebar .user-panel .info {
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #feb353;">
    ...
    <a href="<?php echo e(url('/dashboard')); ?>" class="brand-link">
        <img src="<?php echo e(asset('dist/img/ashton.jpg')); ?>" class="img-circle elevation-2" style="width:30px;height:30px;" alt="Ashton College">
      
      <span class="brand-text font-weight-light">Ashton College</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(asset('dist/img/AdminLTELogo.png')); ?>" alt="Ashton College" class="img-circle elevation-3"
           style="opacity: .8">
        </div>
        <div class="info">
