    ...
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <tr>
            ...
            <td>
              <?php if($course->student_status =='1' && $session->type!='agent'): ?>
                  <a href="<?php echo e(url('student-assign-edit/'.base64_encode($course->student_id))); ?>">
            ...
            <td><button title="<?php echo e($course->message); ?>" class="btn btn-sm btn-danger">Rejected</button></td>  
