...
.container .checkmark:after {
  ...
  <section class="content">
      <div class="row">
          <div class="col-md-12">
          <form role="form" enctype="multipart/form-data" method="post" action="<?php echo e(url('user-package-create-submit')); ?>">
                            ...
                            <select class="selectpicker form-control select_user" data-live-search="true" name="user_id" required="">
                              <option value="" >Select User</option>
                               <?php $__currentLoopData = $users_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($users->id); ?>" ><?php echo e($users->name); ?> (<?php echo e($users->mobile); ?>)</option>
                          ...
                          <div class="form-group">
                            ...
                            <select class="selectpicker form-control select_package" data-live-search="true" name="package_id" required="">
                              <option value="" >Select Package</option>
                               ...
                               <?php $__currentLoopData = $packages_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($packages->id); ?>" ><?php echo e($packages->package_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php if($errors->has('coupon_type')): ?> <p style="color:red;"><?php echo e($errors->first('coupon_type')); ?></p> <?php endif; ?>
                          </div>
                        ...
                        <div class="form-group">
                            <select class="selectpicker form-control select_coupon" data-live-search="true" name="coupon_code">
                              ...
                              <option value="NoCoupons" >Coupon Discard</option>
                               <?php $__currentLoopData = $coupon_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php if($packages->coupon_type=='percentage'): ?>
                                  <option datas="<?php echo base64_encode(json_encode($packages));?>" value="<?php echo e($packages->coupon_code); ?>" ><?php echo e($packages->coupon_code); ?> <?php echo e($packages->coupon_value); ?>%</option>
                                 <?php else: ?>
                                  <option datas="<?php echo base64_encode(json_encode($packages));?>" value="<?php echo e($packages->coupon_code); ?>" ><?php echo e($packages->coupon_code); ?> (-) <?php echo e($packages->coupon_value); ?></option>
                                 <?php endif; ?> 
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
