                ...
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                      ...
                      <?php if($record->status =='1'): ?>         
                        <td><a href="<?php echo e(url('category-change-status/0/'.base64_encode($record->id))); ?>"><button class="btn btn-sm btn-success"><i class="fa fa-check"></i></button></a></td>         
                      <?php else: ?>
                      <td><a href="<?php echo e(url('category-change-status/1/'.base64_encode($record->id))); ?>"><button class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></a></td>        
                     <?php endif; ?>
                      <td>
